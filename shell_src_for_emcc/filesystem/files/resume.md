...
## Summary  
Full Stack Engineer who ships investor-ready MVPs under lean budgets. Experienced in Vue, Supabase, and API design, with a focus on scalable architectures and small-team leadership.

---

## Education  
**Florida State University** — *Master of Information Technology*  
*Expected May 2026*  
- Coursework: Data Mining & Analytics, Advanced Web Development, Information Architecture, Information Behavior  

**Florida State University** — *Bachelor of Computer Science*  
*2019 – 2023*  
...
*Aug 2025 – Present*  
- Directed technical strategy in a 3-person founding team, balancing budget limits with delivery speed.  
- Designed and maintained end-to-end stack: Supabase database, lightweight serverless logic, and FlutterFlow UI/UX.  
- Cut infrastructure costs by leveraging no-backend solutions and low-code tooling while preserving scalability.  
- Coordinated closely with CEO and ML engineer to align product roadmap, delegate tasks, and evaluate technical feasibility.  
- Managed sprints, documentation, and quality standards to keep the product handoff-ready.  
...
*Jul 2021 – Feb 2024*  
- Automated payment reconciliation using Python, cutting manual processing time by 60%.  
- Created SQL audit tools that reduced billing errors across six-figure monthly payment flows.  
...
- **[SoundRoom – Spatial Audio Environment](https://soundroom.live/)**  
...
**Frontend**: Vue, Vite, FlutterFlow  
**Backend**: Supabase, GraphQL, REST APIs  
